...
class MainService(models.Model):
    """
    Model for the list of main services.
    """
...
class Project(models.Model):
    ...
    main_service = models.ForeignKey(MainService, on_delete=models.SET_NULL, null=True)
...
class Section1(models.Model):
    """
    Model for section 1 of the a project page. Conists of one full screen image,
    company name and the main service.
    """
    ...
    img_1 = models.ImageField(upload_to='project_images', blank=False, null=False)
    ...
    def __str__(self):
        return f"{self.project.company}: Section 1"
...
class Section2(models.Model):
    """
    Model for section 2 of the a project page. Conists of one image,
    a list of services and a text description.
    """
    project = models.ForeignKey(Project, on_delete=models.CASCADE)
    template = models.ForeignKey(Template, on_delete=models.SET_NULL, null=True)
    ...
    img_1 = models.ImageField(upload_to='project_images', blank=False, null=False)  # img_1 cannot be null
    img_1_description = models.TextField(blank=True, null=True)
    services = models.ManyToManyField(Service)  # Corrected: ManyToManyField does not accept null=False
    ...
    def clean(self):
        ...
        if self.change_header_color and not self.new_header_color:
            raise ValidationError("New Header Color and New Header Color Hover must be set if 'Change Header Color' is checked.")
    ...
    def __str__(self):
        return f"{self.project.company}: Section 2"
...
class Section(models.Model):
    ...
    # Image fields
    img_1 = models.ImageField(upload_to='project_images', blank=True, null=True, default="default.jpg")  # First image
    img_2 = models.ImageField(upload_to='project_images', blank=True, null=True, default="default.jpg")  # Second image
    img_3 = models.ImageField(upload_to='project_images', blank=True, null=True, default="default.jpg")  # Third image
    img_4 = models.ImageField(upload_to='project_images', blank=True, null=True, default="default.jpg")  # Fourth image
    img_5 = models.ImageField(upload_to='project_images', blank=True, null=True, default="default.jpg")  # Fifth image
    img_6 = models.ImageField(upload_to='project_images', blank=True, null=True, default="default.jpg")  # Sixth image
    ...
    def clean(self):
        ...
        # Validate custom HTML and CSS fields
        if self.use_custom_html:
            if not self.custom_html:
                raise ValidationError("Custom HTML must be provided if 'Use Custom HTML' is checked.")
            if not self.html_description_name:
                raise ValidationError("HTML Description Name must be provided if 'Use Custom HTML' is checked.")
...
class ProjectPage(models.Model):
    ...
    project = models.ForeignKey(Project, on_delete=models.CASCADE)
    section_1 = models.ForeignKey(Section1, on_delete=models.CASCADE, null=True, blank=True, related_name='section_1')
    section_2 = models.ForeignKey(Section2, on_delete=models.CASCADE, null=True, blank=True, related_name='section_2')
